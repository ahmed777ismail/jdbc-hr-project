...
public class EmployeeNamedParameterJDBCRepo implements EmployeeReps {
    ...
    // public EmployeeNamedParameterJDBCRepo(NamedParameterJdbcTemplate
    ...
    public int count() {
        ...
        // namedParameterJdbcTemplate.queryForObject("select count(*) from employees",
        // Integer.class);
        return 0;
    }
    ...
    public List<Employee> findByNameAndSalary(String name, Double salary) {
        ...
        return namedParameterJdbcTemplate.query(
                "select id, name, salary from employees where name = :name and salary = :salary", mapParam,
                new EmployeeMapper());
    }
    ...
    public List<Employee> findAll() {
        ...
        // jdbcTemplate.query("select id, name, salary from employees" , new
        // EmployeeMapper());
        return null;
    }
    ...
    public int insert(Employee employee) {
        ...
        return namedParameterJdbcTemplate.update(
                "insert into employees (id, name, salary) values (:employeeId, :name, :salary)",
